...
reserves = read_sf("tdata/PL.PZGiK.201.30/BDOO/PL.PZGIK.201.30__OT_ADMS_P.xml")
p = reserves[1, ]
req_df = ortho_request(p)
tile_download(subset(req_df, filename == "73559_910397_N-33-130-D-d-1-2"),
              outdir = "./tdata")

r = rast("tdata/73559_910397_N-33-130-D-d-1-2.tif")
...
writeRaster(r3, "inst/raster/ortho.tif", overwrite = TRUE, datatype = "INT1U")
