...
`compactness = use_adaptive()` enables adaptive compactness (ASLIC). This lets the method adjust compactness across supercells rather than using a single fixed value.
