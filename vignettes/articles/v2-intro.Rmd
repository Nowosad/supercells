...
Alternatively, `compactness = use_adaptive()` enables ASLIC-style adaptive compactness when you want the algorithm to adjust locally -- this does not require setting a specific value, but also takes away direct control.
