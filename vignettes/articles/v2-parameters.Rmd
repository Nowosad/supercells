...
The global version looks at overall balance, while the local version uses a neighborhood-based estimate.
<!-- The global estimate is pixel-weighted, while the local estimate is a median of per-center mean distances. -->
