...
extern SEXP _slicr_run_slic(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);

static const R_CallMethodDef CallEntries[] = {
    {"_slicr_a",        (DL_FUNC) &_slicr_a,        1},
    {"_slicr_run_slic", (DL_FUNC) &_slicr_run_slic, 7},
    {NULL, NULL, 0}
};
}
